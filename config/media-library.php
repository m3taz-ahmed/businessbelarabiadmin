...
return [
    ...
    /*
     * When enabled, Media L ibrary Pro will only process temporary uploads that were uploaded
     ...
     * a `loading` attribute to the `img` tag. By default the media library
     * will add `lazy` as the value.
     *
